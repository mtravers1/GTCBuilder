        ...
        <>
            <Accordion variant="default" defaultValue="default" className="bg-white rounded-default">
                <Accordion.Item value="default">
                    <Accordion.Control><span className='font-bold'>Video</span></Accordion.Control>
                    <Accordion.Panel>
                        {/* Video */}
                        <a href="https://www.youtube.com/watch?time_continue=6&v=3fKqCTe_hVI&feature=emb_title" target="_blank" rel="noopener noreferrer">
                            <div className='relative flex justify-center items-center'>
                                <Image
                                    ...
                                    alt="video thumbnail"
                                />
                                <div className="absolute"><IconPlayerPlay size={100} className="text-white" /></div>
                            </div>
                        </a>
