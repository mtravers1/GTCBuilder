...
import { IconMapPin, IconCurrencyDollar, IconBuilding, IconSearch } from '@tabler/icons';
        ...
        <>
            <div className="relative ">
                ...
                <div className="absolute drop-shadow-lg top-0 left-0 flex flex-col h-full w-full laptop:mt-56 mt-24 items-center space-y-2 ">
                    <h1 className="pc:text-6xl text-4xl text-white text-left font-bold">{basicsInfoConstants.name}</h1>
                    <h1 className="pc:text-4xl tablet:text-2xl text-xl text-white text-center">{basicsInfoConstants.subtitle1}</h1>
                ...
                <div className="flex laptop:flex-row flex-col laptop:space-x-4 laptop:space-y-0 space-y-2">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <div className="pc:w-auto w-full">
                            ...
                            <Input radius="sm" icon={<IconSearch />} placeholder="Search..." />
                        </div>
                    </div>
                </div>
            </div>
