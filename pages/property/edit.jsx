...
export default function Index({ property: theProperty }) {
  const property = {
    ...theProperty,
  };
  delete property.createdAt;
  delete property.titleSlug;
  delete property.typeSlug;
  ...
  //   documentLinks: property.documentLinks,
  //   features: property.features,
  //   floors: property.floors,
  //   virtualLink: property.virtualLink,
  //   videoLink: property.videoLink,
  //   videoCoverImageLink: property.videoCoverImageLink,
  //   type: property.type,
  //   title: property.title,
  //   sqFoot: property.sqFoot,
  //   price: property.price,
  //   location: property.location,
  //   isTopproperty: property.isTopproperty,
  ...
  const { isLoading, putProtectedData } = useHttpServices();
  const handleAddProperty = async () => {
    ...
    const data = await putProtectedData(
      `${properties.updateProperty}/${theProperty.id}`,
      {
        ...body,
...
export async function getServerSideProps({ query }) {
  ...
  try {
    const property = await getData(`/gtc/properties/${id}`);
    ...
    console.log(error);
    return {
      props: { error: "fail" }, // will be passed to the page component as props
    };
  }
}
